<?php 
  ...
  if (isset($_POST['btnLaporanPemasukkan'])) {
  	...
  	$sql = mysqli_query($conn, "SELECT * FROM bulan_pembayaran INNER JOIN uang_kas ON bulan_pembayaran.id_bulan_pembayaran = uang_kas.id_bulan_pembayaran INNER JOIN warga ON uang_kas.id_warga = warga.id_warga WHERE bulan_pembayaran.id_bulan_pembayaran = '$id_bulan_pembayaran'");
	        			...
	        			<table class="table table-bordered table-hover">
	        				...
	        				<tbody>
	        					...
	        					<?php foreach ($sql as $ds): ?>
	        						<tr>
	        							<td><?= $i++; ?></td>
	        							<td><?= ucwords(htmlspecialchars_decode($ds['nama_warga'])); ?></td>
